...
# Create a list of dicts with `date` and `prcp` as the keys and values
    ...
    for result in rain:
        ...
        row["precipitation"] = result.precipitation
...
def stations():
    ...
    for station in stations:
        ...
        stations_dict["station_name"] = station.name
        stations_dict["station_latitude"] = station.latitude
        stations_dict["station_longitude"] = station.longitude
        stations_dict["station_elevation"] = station.elevation
